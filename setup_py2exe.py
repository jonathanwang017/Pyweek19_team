...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "walls_pyweek19.py"

        #Name of program
        self.project_name = "Walls"
        ...
        self.license = "Walls_pyweek19 License"

        #Auhor of program
        self.author_name = "jonw665, myonkorux, mchawla33"
        self.author_email = "example@example.com"
        self.copyright = "Copyright (c) 2014 Team Band Camp."

        #Description
        self.project_description = "Walls_pyweek19 Description"

        #Icon file (None will use pygame default icon)
        self.icon_file = None

        #Extra files/dirs copied to game
        self.extra_datas = ["audio.py","levels.py",'block.gif', \
			'ghost.gif', \
			'goal.gif', \
			'goal_animation.gif', \
			'player.gif', \
